var postUpdate=(function(){
    ...
    return {
        ...
        stepHandler:function(stepId){
            if(stepId!="#zyupStep1"){
                if($("#zyupTitleInput").val()==""||$("#zyupAuthorInput").val()==""||
                    $("#zyupDescriptionTxt").val()==""||$("#zyupAnalysisTxt").val()==""||$("#zyupSizeInput").val()==""||
                    $("#zyupThumbUrl").val()==""||!$("#zyupCategorySel").val()||!$("#zyupMaterialSel")){
                    $().toastmessage("showErrorToast",config.message.stepOneUnComplete);
                    return false;
                }
            }
            ...
            if(stepId=="#zyupStep3"){
                ...
                if($(".zyupMediaItem").length==0||$(".zyupUnCompleteLi").length!=0){
                    $().toastmessage("showErrorToast",config.message.stepTwoUnComplete);
                    return false;
                }
