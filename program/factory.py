...
from .core import db, mail, security, redis_cache, SimpleSQLAlchemyUserDatastore
...
def create_app(package_name, package_path, setting_override=None, register_security_blueprint=True):
    ...
    mail.init_app(app)
    security.init_app(app, SimpleSQLAlchemyUserDatastore(db, User), register_blueprint=register_security_blueprint)
